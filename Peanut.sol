...
contract Peanut is ERC20A("Peanut", "PNUT") {
	...
	Ipeanut public ipeanut = Ipeanut(0x0000000000000000000000000000000000000000); // Address yieldToken
	address public yieldHub = 0x0000000000000000000000000000000000000000; // Address yieldHub
